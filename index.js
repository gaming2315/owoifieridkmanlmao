...
var MessageActions = (0, import_metro.findByProps)("sendMessage", "editMessage");
var wordMap = {
  mr: "mistuh",
  dog: "doggo",
  cat: "kitteh",
...
function onLoad() {
  ...
  import_common.FluxDispatcher.subscribe("MESSAGE_CREATE", receiveMessagePatch);
}
function onUnload() {
  unpatchSendMessage?.();
  import_common.FluxDispatcher.unsubscribe("MESSAGE_CREATE", receiveMessagePatch);
}
